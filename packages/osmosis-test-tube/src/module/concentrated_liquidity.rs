use osmosis_std_modified::types::osmosis::concentratedliquidity::poolmodel::concentrated::v1beta1::{
    MsgCreateConcentratedPool, MsgCreateConcentratedPoolResponse,
};
use osmosis_std_modified::types::osmosis::concentratedliquidity::v1beta1::{
...
mod tests {
    ...
    use osmosis_std_modified::types::cosmos::base::v1beta1;
    use osmosis_std_modified::types::osmosis::concentratedliquidity::v1beta1::{
        CreateConcentratedLiquidityPoolsProposal, Pool, PoolRecord,
    };
    use osmosis_std_modified::types::osmosis::tokenfactory::v1beta1::{MsgCreateDenom, MsgMint};
    use prost::Message;
