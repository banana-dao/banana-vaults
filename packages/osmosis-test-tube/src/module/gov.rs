...
use osmosis_std_modified::shim::Any;
use osmosis_std_modified::types::cosmos::base::v1beta1::Coin;
use osmosis_std_modified::types::cosmos::gov::v1beta1::{
...
mod tests {
    #[allow(deprecated)]
    use osmosis_std_modified::types::osmosis::cosmwasmpool::v1beta1::UploadCosmWasmPoolCodeAndWhiteListProposal;
