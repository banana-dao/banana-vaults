...
use osmosis_std_modified::types::osmosis::gamm;
use osmosis_std_modified::types::osmosis::gamm::poolmodels::stableswap::v1beta1::{
        ...
        self.create_balancer_pool(
            MsgCreateBalancerPool {
                ...
                pool_assets: initial_liquidity
                    .iter()
                    .map(|c| PoolAsset {
                        token: Some(osmosis_std_modified::types::cosmos::base::v1beta1::Coin {
