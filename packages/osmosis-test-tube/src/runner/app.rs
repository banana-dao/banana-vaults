...
#[cfg(test)]
mod tests {
    use osmosis_std_modified::types::cosmos::bank::v1beta1::QueryAllBalancesResponse;
    use prost::Message;
    use std::option::Option::None;

    use cosmrs::Any;
    use cosmwasm_std::{attr, coins, Coin};
    use osmosis_std_modified::types::cosmos::bank::v1beta1::QueryAllBalancesRequest;

    use osmosis_std_modified::types::osmosis::gamm::v1beta1::QueryTotalSharesRequest;
    use osmosis_std_modified::types::osmosis::lockup::{
        self, MsgForceUnlock, MsgForceUnlockResponse, MsgLockTokens, MsgLockTokensResponse,
    };
    use osmosis_std_modified::types::osmosis::tokenfactory::v1beta1::{
    ...
    fn test_multiple_as_module() {
        ...
        assert_eq!(
            pool_liquidity
                .into_iter()
                .map(|c| c.into())
                .collect::<Vec<osmosis_std_modified::types::cosmos::base::v1beta1::Coin>>(),
            pool.pool_assets
                .into_iter()
    ...
    fn test_set_param_set() {
        ...
        app.execute::<_, MsgLockTokensResponse>(
            MsgLockTokens {
                ...
                duration: Some(osmosis_std_modified::shim::Duration {
                    seconds: 1000000000,
                    nanos: 0,
                }),
                coins: shares,
