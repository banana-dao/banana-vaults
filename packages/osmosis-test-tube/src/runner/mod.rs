...
mod tests {
    ...
    use osmosis_std_modified::types::cosmos::bank::v1beta1::{MsgSendResponse, QueryBalanceRequest};
    use osmosis_std_modified::types::cosmwasm::wasm::v1::{
        MsgExecuteContractResponse, MsgInstantiateContractResponse,
    };
    use osmosis_std_modified::types::osmosis::gamm::poolmodels::balancer::v1beta1::{
        MsgCreateBalancerPool, MsgCreateBalancerPoolResponse,
    };
    use osmosis_std_modified::types::osmosis::gamm::v1beta1::PoolParams;
    use osmosis_std_modified::types::osmosis::poolmanager::v1beta1::{PoolRequest, PoolResponse};
